...
def test_withdraw_reentrancy(token_bridge_wrapper: TokenBridgeWrapper, messaging_contract):
    setup_contracts(
        token_bridge_wrapper=token_bridge_wrapper,
        initial_bridge_balance=WITHDRAW_AMOUNT * 999,
    )
    ...
    assert token_bridge_wrapper.get_account_balance(token_bridge_wrapper.non_default_user) == (
        initial_user_balance + WITHDRAW_AMOUNT * 4
    )
